  ...
  return knex('industries').insert([
    {
      ...
      remarks:
        'Educational Consultancy which deals with immigration and international education.',
      created_by: 2
    },
    {
      name: 'Manpower',
    ...
    },
    {
      ...
      remarks:
        'Deals with Information Technology systems, especially softwares and embedded systems.',
      created_by: 4
    },
    {
      name: 'Hospatility',
