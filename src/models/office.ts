...
export async function fetch(
  ...
  return db
    ...
    .where(whereParam)
    .then( (response: any) => response.map((data: any) => mapOfficeToModel(data)));    
}
...
function mapOfficeToModel(obj: any): Office{
  const office: Office = {
       ...objectUtil.withOnlyAttrs(obj,[
           'id', 'name', 'location', 'locationGps', 'noOfEmployees', 'maxBudget', 'phone', 'panNo',
           'regdNo', 'isVerified', 'createdAt', 'updatedAt', 'verifiedAt','deliveryTime', 'remarks'
       ]),
  };
